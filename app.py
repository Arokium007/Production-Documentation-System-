...
# --- Helper: Scrape URL Data (Text + HTML structure for Images) ---
...
# --- Helper: New SpecSheet Content Generation ---
...
# --- Helper: Extract SPECIFIC Model Image (PDF Fallback) ---
