...
database_url = os.environ.get('DATABASE_URL', 'sqlite:///' + os.path.join(basedir, 'instance', 'pis_system.db'))
# Fix: EasyPanel gives mysql:// but SQLAlchemy needs mysql+pymysql://
